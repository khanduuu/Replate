  ...
  head: () => ({
    meta: [
      ...
      { title: "Replate — Rescue surplus food, feed your city" },
      {
        name: "description",
        content:
          "Replate connects restaurants, hotels, caterers and event organizers with verified NGOs to redistribute surplus food before it expires.",
      },
      { property: "og:title", content: "Replate — Rescue surplus food" },
      {
        property: "og:description",
        content:
          "A live marketplace for surplus food donations between businesses and NGOs.",
      },
